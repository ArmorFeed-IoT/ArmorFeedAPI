...
public class JwtHandlerShipmentDriver : IJwtHandler<ShipmentDriver.Domain.Models.ShipmentDriver>
{
    private readonly AppSettings _appSettings;

    public JwtHandlerShipmentDriver(IOptions<AppSettings> appSettings)
    {
        _appSettings = appSettings.Value;
    }

    public string GenerateToken(ShipmentDriver.Domain.Models.ShipmentDriver user)
    {
